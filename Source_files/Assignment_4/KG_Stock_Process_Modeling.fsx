...
module Generator =
    ...
    let generateSaveToFile (steps: int)(seed: int) =
        let writer = new System.IO.StreamWriter("C:\Users\Kris\Documents\Studia\Quant Scholarship\Source_files\Assignment_4\Results\generatedSNV.csv")
...
module Simulation =
    ...
    let simulate (count: int)(steps: int)(price: double)(drift: double)(vol: double)(years: double)(seed: int)(filePath: string) =
...
Simulation.simulate 1500 300 100 0.05 0.2 1. 5 "C:\Users\Kris\Documents\Studia\Quant Scholarship\Source_files\Assignment_4\Results\output_1.txt"
//test simulation with vol=0
Simulation.simulate 1500 300 100 0.05 0. 1. 5"C:\Users\Kris\Documents\Studia\Quant Scholarship\Source_files\Assignment_4\Results\output_2.txt"
